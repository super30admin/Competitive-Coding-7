...
//Space - O(1)
// n = total elements in matrix (count method -> find size of left half of matrix); 
// max -> last element in matrix; min - 1st element in matrix
//we always work on search space which is max- min
