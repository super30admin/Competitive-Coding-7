...
# I start with 0,0 and I put the right and down element in heap. I pop an element before adding the elements. After k steps I will find the kth smallest element
