// 1. Sort the given array Intervals on basis of meeting start times
// 2. Create a Min heap of End times of meetings (so that the 'earliest to end'' meeting is always on the top of heap). 
//     Insert the 1st meeting end time
...
// 5. Return the heap size as that is the No. of rooms required
...
public class MeetingRoom2{
    public int minMeetingRoon(int[][] intervals){
